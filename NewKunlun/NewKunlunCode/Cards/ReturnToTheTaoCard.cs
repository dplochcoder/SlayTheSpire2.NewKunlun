...
[CardLocalization(
    ...
    description: "Whenever [gold]Internal Damage[/gold] resolves on enemies this turn, immediately reapply it.\nDeal {Damage:diff()} damage to all enemies {Repeats:diff()} times."
)]
    ...
    : NewKunlunCard(2, CardType.Attack, CardRarity.Rare, TargetType.AllEnemies)
{
    ...
    protected override void OnUpgrade() => Repeats.UpgradeValueTo(5M);
